...
const folderLocation = 'K:/Dropbox/NodeJS/YTPMV Metadata Archive JSON/split_parts2/vids';
// The folder where the further divided files are saved to
const folderLocationDest = 'K:/Dropbox/NodeJS/YTPMV Metadata Archive JSON/split_parts3/vids';
